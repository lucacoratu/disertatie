...
const HTTPHighlighter: FC<HTTPHighlighterProps> = ({log}): JSX.Element => {
    ...
    return (
        <div className="flex flex-wrap flex-row gap-3 justify-center">
            <div className="flex flex-col gap-0 h-[500px] min-w-[450px] grow w-1/3 p-4 bg-card rounded border b-2 rounded-xl">
            ...
            <div className="flex flex-col gap-0 h-[500px] min-w-[450px] grow w-1/3 p-4 rounded bg-card border b-2 rounded-xl">
                <div className="flex flex-row items-center justify-between gap-10">
